...
public class OrderSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        balloon = new Balloon.Builder(OrderSummaryActivity.this)
                .setArrowSize(10)
                ...
                .setCornerRadius(11f)
                .setAlpha(1.0f)
                .setBackgroundColor(ContextCompat.getColor(OrderSummaryActivity.this, R.color.pure_black))
...
//            loadStatus();
    ...
    private void loadData() {
        ...
        Call<JsonArray> call = myApi.myOrder(user.getId(), orderId);
                                    ...
                                    if(mainTIme<minuts) {
                                        ...
                                        binding.link.setOnClickListener(
                                                new View.OnClickListener() {
                                                    @Override
                                                    public void onClick(View v) {
                                                       showRateDialoge1(OrderSummaryActivity.this);
                                                    }
                                                }
                                        );
...
//                        String message = jsonObject.getString("message");
                        if (res.equals("success")) {
                            ...
                            binding.lineMobile.setVisibility(View.GONE);
                            binding.addNumber.setVisibility(View.GONE);
                            Toast.makeText(OrderSummaryActivity.this, "Number Added ", Toast.LENGTH_SHORT).show();

                        } else {
                            Toast.makeText(OrderSummaryActivity.this, "Number Not Added", Toast.LENGTH_SHORT).show();
...
//        binding.Amount.setText("₹ " + myOrder.getAmount());
        binding.viewCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(OrderSummaryActivity.this, CheckOutActivity.class));
...
//                            changeStatus("Missed");
    ...
    private void reorder(String id,String userId) {
        ShowProgress.getShowProgress(OrderSummaryActivity.this).show();
        MyApi myApi = singleTask.getRetrofit().create(MyApi.class);
            ...
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (res.equals("success")) {
                            ShowProgress.getShowProgress(OrderSummaryActivity.this).hide();
...
//        alert2.setCanceledOnTouchOutside(false);
    ...
    private void submitFeedback(String txt,android.app.AlertDialog alert2) {
        ProgressDialog progressDialog=ProgressDialog.show(OrderSummaryActivity.this,"","Loading");
        String js=singleTask.getValue("user");
        User user=new Gson().fromJson(js,User.class);
        MyApi myApi=singleTask.getRetrofit1().create(MyApi.class);
