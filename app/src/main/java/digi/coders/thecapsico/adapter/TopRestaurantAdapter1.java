...
public class TopRestaurantAdapter1 extends RecyclerView.Adapter<TopRestaurantAdapter1.AdapterViewHolder> {
    Context context;
    ...
    public TopRestaurantAdapter1(Context context, List<Merchant> merchantList,String u_id) {
    ...
    @NonNull
    @Override
    public TopRestaurantAdapter1.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TopRestaurantAdapter1.AdapterViewHolder holder, int position) {
...
//                            StoreDetailsActivity.merchant1=merchant;
    ...
    private void addWishlist(String clear, TopRestaurantAdapter1.AdapterViewHolder holder, String id)
    {
