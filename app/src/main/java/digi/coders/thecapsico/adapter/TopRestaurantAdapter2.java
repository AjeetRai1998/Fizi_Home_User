...
public class TopRestaurantAdapter2 extends RecyclerView.Adapter<TopRestaurantAdapter2.AdapterViewHolder> {
    Context context;
    ...
    public TopRestaurantAdapter2(Context context, List<Merchant> merchantList,String u_id) {
    ...
    @NonNull
    @Override
    public TopRestaurantAdapter2.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TopRestaurantAdapter2.AdapterViewHolder holder, int position) {
...
//                            StoreDetailsActivity.merchant1=merchant;
    ...
    private void addWishlist(String clear, TopRestaurantAdapter2.AdapterViewHolder holder, String id)
    {
