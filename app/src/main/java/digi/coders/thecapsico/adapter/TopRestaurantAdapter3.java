...
public class TopRestaurantAdapter3 extends RecyclerView.Adapter<TopRestaurantAdapter3.AdapterViewHolder> {
    Context context;
    ...
    public TopRestaurantAdapter3(Context context, List<Merchant> merchantList,String u_id) {
    ...
    @NonNull
    @Override
    public TopRestaurantAdapter3.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TopRestaurantAdapter3.AdapterViewHolder holder, int position) {
...
//                            StoreDetailsActivity.merchant1=merchant;
    ...
    private void addWishlist(String clear, TopRestaurantAdapter3.AdapterViewHolder holder, String id)
    {
