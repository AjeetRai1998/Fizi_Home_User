...
public class TopRestaurantAdapter extends RecyclerView.Adapter<TopRestaurantAdapter.AdapterViewHolder> {
    Context context;
    ...
    public TopRestaurantAdapter(Context context, List<Merchant> merchantList,String u_id) {
    ...
    @NonNull
    @Override
    public TopRestaurantAdapter.AdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TopRestaurantAdapter.AdapterViewHolder holder, int position) {
...
//                            StoreDetailsActivity.merchant1=merchant;
    ...
    private void addWishlist(String clear, AdapterViewHolder holder,String id)
    {
